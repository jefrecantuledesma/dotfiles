...
alias brrr='curl wttr.in/Fairfax?0Fnu'
alias oops='cd -'
alias find='fd -E /home/fribbit/.snapshots/ -E /btrfs_backups -E /build/ -E /home/fribbit/Documents/mount_point/@backups/'
alias sway='Exec=env WLR_RENDERER=vulkan sway'
alias wyrd='wyrd /home/fribbit/.config/remind/reminders'
flatten() {
  if [ "$#" -ne 2 ]; then
    echo "Usage: flatten <input.pdf> <output.pdf>"
    return 1
  fi
